// src/collection/app.ts
import { MissingCollectionSlug } from "../core/errors/consoleErrors.js";
var withAppUsersCollection = (incomingCollection) => {
...
var withAppAccountCollection = (incomingCollection, usersCollectionSlug) => {
  if (!incomingCollection.slug) {
    throw new MissingCollectionSlug;
  }
  const collectionConfig = {
